...
class WebRTCServer:
    ...
    def testfunction(self):
        '''
        '''         
        ret0 = self.webrtc.emit ("get-transceiver", 0)
        ret1 = self.webrtc.emit ("get-transceiver", 1)
        rets = self.webrtc.emit ("get-transceivers")
        print('ret0.direction:', ret0.direction)
        print('ret1.direction:', ret1.direction)
        print('rets.data', rets.data)
